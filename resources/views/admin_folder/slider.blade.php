...
<a  href="/list_sliders">  <button   class="btn btn-primary">  List slider  </button>  </a>
...
<input  style="display: none"  onChange="upoad_file(event,'upload_slider','progress_id' , 'message_id', 'picture' , '/slider_store' , 'addind_content')"     id="picture"   type="file"   name="picture"   />
