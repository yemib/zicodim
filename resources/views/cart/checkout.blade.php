	...
	<div class="container  mycontainer" style="margin-top: 150px">
		...
		?>
				...
				{{-- 
	             ...
	             {{--    <div class="col-sm-12" style="width: 100% ; padding: 10px  ;background-color: #fff5e6; color: #b87300">
						 <strong>Select a Pickup </strong></div> --}}
				{{-- 
	                <div  style="display: none" id="define_addressess" style="" class="col-sm-12">
						...
						$pick_client_address  =client::where('id' , session('client')['id'])->first();
