            ...
            <div data-aos="zoom-out-up" id="ex3" style="" class="col-sm-12">
                <h5>
                    <p>
                        ...
                        <br />
                        product name : <a target="_blank" href="/product/{{  $product->id }}"> {{ $order->product->name  }} </a>
                        <br />
                                                    ...
                                                    <div class="wpcp-single-item">
                                                        <a href="{{ $image['new_name'] }}">
                                                            <div class="wpcp-slide-image">
                                                                ...
                                                                <div style="background-image: url('{{ $image['new_name'] }}')" class="image_container_product">
                ...
                <div class="">
                    ...
                    <div class="col-sm-12" style="width: 100%">
                        ...
                        <hr />  
                         ...
                         <div class="">
                            <div class="totalbusiness-content">
                                @if(isset($order->product->picture))
        
                                @if($order->product->picture != NULL)

                                <?php $image =    json_decode($order->product->picture , true);   ?>


                                <a href="{{ $image[0]['new_name'] }}">
                                 



                                        <div style="background-image: url('{{ $image[0]['new_name'] }}')" class="image_container_product">
