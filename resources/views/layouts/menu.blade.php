        ...
        <div class="top-navigation-container container">
            ...
            <div class="top-navigation-right">
                ...
                {{--     <div class="social-icon">
                    ...
                    <div class="social-icon">
                        <a href="https://api.whatsapp.com/send?phone={{ $contact->whatapp }}" target="_blank">
                            <i class="fa fa-whatsapp"></i></a>
                    </div>

                    <div class="social-icon">
                        <a href="tel:{{ $contact->support }}" target="_blank">
        ...
        <div class="totalbusiness-header-container container">
            ...
            <div class="totalbusiness-logo">
                <div class="totalbusiness-logo-inner">
                    <a href="/">
                        <img src="/slider/{{ $logo->picture }}" alt="{{ config('app.name') }}" width="227"
                            height="227" /> </a>
                </div>
                    ...
                    <ul id="menu-menu-2" class="sf-menu totalbusiness-main-menu">
                        ...
                        <li
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item menu-item-type-custom  menu-item-{{ $count }}"><a
                                        href="/category/{{ $cat->id }}">{{ $cat->name }}</a></li>
