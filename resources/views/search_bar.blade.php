<form method="" action="/search" style="width: 80% !important ; margin-right: 50px" class="navbar-form navbar-right form-container " role="search">
        <div class="form-group" style="width: 80%">
           ...
           <input required="" value="@if(isset($_GET['q'])){{$_GET['q']}}@endif" style="width: 100%;  padding: 20px ; font-size: 18px " type="text" class="form-control" id="jsSearchInput" name="q" placeholder="Search for products">
