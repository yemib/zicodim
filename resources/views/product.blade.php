        ...
        <div id="space_up" class="row">
            ...
            <div style="overflow: auto; background: rgba(255,255,255,1.00)  ; padding: 10px">
                ...
                <div data-aos="zoom-out-up" id="ex3" style="" class="col-sm-12">
                  ...
                  {{--   <span class="price_size"> &#x20A6; <strong> {{ number_format($product->price) }}</strong> </span>

                    @if ($product->coupon_price != 0)
                        <p style="display: inline-block; " align="right"> <strong id="second_price"
                                style="text-decoration: line-through  ; color:#9b9b9b  ">&#x20A6;{{ number_format($product->coupon_price) }}</strong>
                        </p>
                    @endif
 --}}
                    ...
                    <div class="">
                        <div class="totalbusiness-content">
                            ...
                            <a  class="btn btn-sm  btn-success" href="/cart/addItem/{{ $product->id }}/next">  <strong
                                        ...
                                        <div class="container">
                                            <div class="totalbusiness-item totalbusiness-content-item"
                                                ...
                                                <div id="wpcpro-wrapper" class="wpcp-carousel-wrapper wpcp-wrapper-1041">
                                                    ...
                                                    @foreach ( $all_products as  $image )
                                                      
                                                 
                                                        <div class="wpcp-single-item">
                                                          <a  href="{{ $image['new_name'] }}">
                                                            <div class="wpcp-slide-image">

                                                             
                                                              
                                                          <div  style="background-image: url('{{ $image['new_name'] }}')"  
                ...
                <div style="" class="col-sm-12">
                    ...
                    <div class="">
                        ...
                        <div class="col-sm-12" style="width: 100%">
                            ...
                            <form   action="{{  route('place_order') }}"  id="Form1"   method="POST" action="">
                                <h5>Make Enquiry</h5>
                            ...
                            <div>
                                ...
                                <div class="fb-share-button" data-href="https://{!! $_SERVER['HTTP_HOST'] !!}"
                                    data-layout="button" data-size="large"><a target="_blank"
                                        href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2F{!! $_SERVER['HTTP_HOST'] !!}%2F&amp;src=sdkpreparse"
