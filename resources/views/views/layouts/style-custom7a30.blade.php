...
.top-navigation-wrapper{ background-color: {{config('app.color2')}}; }
...
.totalbusiness-top-woocommerce, .totalbusiness-top-woocommerce-inner > a, .totalbusiness-menu-search input[type="text"]{ color: {{config('app.color')}}; }
...
#totalbusiness-responsive-navigation.dl-menuwrapper button { background-color: {{config('app.color2')}}; }
#totalbusiness-responsive-navigation.dl-menuwrapper button:hover, #totalbusiness-responsive-navigation.dl-menuwrapper button.dl-active, #totalbusiness-responsive-navigation.dl-menuwrapper ul{ background-color: {{config('app.color2')}}; }
...
body{ color: #808080; }
a{ color: {{config('app.color')}}; }
a:hover{ color: {{config('app.color2')}}; }
body *{ border-color: #dddddd; }
.page-not-found-block{ background-color: {{config('app.color')}}; }
.page-not-found-block{ color: #ffffff; }
.page-not-found-search  .gdl-search-form input[type="text"]{ background-color: {{config('app.color2')}}; }
...
.totalbusiness-post-slider-item.style-no-excerpt .totalbusiness-caption-wrapper .totalbusiness-caption-date, .totalbusiness-post-slider-item.style-no-excerpt .totalbusiness-caption-wrapper .totalbusiness-title-link{ background-color: {{config('app.color')}}; }
...
.footer-wrapper .totalbusiness-button, .footer-wrapper input[type="button"], .footer-wrapper input[type="submit"]{ background-color: {{config('app.color')}}; }
.footer-wrapper .tagcloud a{ background-color: {{config('app.color')}}; }
.footer-wrapper .tagcloud a, .footer-wrapper .tagcloud a:hover{ color: #ffffff; }
.copyright-wrapper{ background-color: {{config('app.color')}}; }
.copyright-wrapper{ color: #ffffff; }
.footer-wrapper .copyright-wrapper{ border-color: {{config('app.color')}}; }
...
.txt-yellow { color: {{config('app.color2')}}; }
...
.totalbusiness-main-menu > li.current-menu-item > a { border-bottom: solid 6px {{config('app.color')}}; }
.totalbusiness-main-menu > li:hover > a { border-bottom: solid 6px {{config('app.color')}}; }
...
@media only screen and (max-width: 767px)
{
     .totalbusiness-header-wrapper.header-style-6-wrapper .totalbusiness-header-inner { 
       background: {{config('app.color')}} !important;  }
     .dl-menuwrapper > .dl-menu, .dl-menuwrapper > .dl-submenu { margin-top: 0px; }
}

.totalbusiness-header-wrapper.header-style-6-wrapper .top-navigation-wrapper { background: {{config('app.color2')}}; }
...
.totalbusiness-main-menu > li:last-of-type a {  font-size: 24px !important;
    ...
    border-bottom: solid 24px {{config('app.color2')}};
    margin-top: -26px;
...
.totalbusiness-main-menu > li:last-of-type a:hover { 
     background: blue; 
     color: {{config('app.color')}};  
     border-bottom: solid 24px {{config('app.color')}}; }

.totalbusiness-main-menu > li:last-of-type a:hover .txt-yellow { color: {{config('app.color')}};  }
...
{ 
     ...
     .totalbusiness-main-menu > li:last-of-type a {  font-size: 17px !important;
       ...
       border-bottom: solid 18px {{config('app.color2')}}; }
...
h3.order-now-title, h3.order-now-title-menu { text-align: center; 
    ...
    text-align: center;
    background-color: {{config('app.color2')}};
    color: {{config('app.color')}}; 
    font-size: 27px;
...
h3.order-now-title:hover {
    ...
    color: {{config('app.color')}};   }
h3.order-now-title:hover a { color: {{config('app.color')}};   }

h3.order-now-title-menu:hover {  background-color: {{config('app.color')}};
    color: #ffffff; }
h3.order-now-title-menu:hover a { color: #ffffff; }

div#rest.totalbusiness-item.totalbusiness-content-item { background-color: {{config('app.color')}};
...
a.sl-btn {  color: #ffffff;
    background: {{config('app.color')}};
    border-bottom: solid 8px {{config('app.color2')}};
    padding: 10px;
    font-weight: bold;
    font-size: 18px;}
...
a.sl-btn:hover {  color: white;
    ...
    border-bottom: solid 8px {{config('app.color')}};}
...
span.spread-title-red { color: {{config('app.color')}};
font-family: 'GrilledCheeseBold';
    font-size: 51px;
    font-weight: bold; } 
...
span.shout {color: {{config('app.color')}};
    font-weight: bold; }
...
a.sl-btn {  font-size: 12px; border-bottom: solid 4px {{config('app.color2')}}; padding: 5px;  }
a.sl-btn:hover {  border-bottom: solid 4px {{config('app.color')}}; }
...
#menu-item .portfolio-overlay-icon:hover  { color: {{config('app.color')}}; }
...
#hover3 .portfolio-thumbnail .portfolio-overlay::after {
  ...
  width: 0;
  height: 100%;
  background-color: {{config('app.color')}};
  background: {{config('app.color')}};
...
.totalbusiness-blog-grid .totalbusiness-blog-grid-content { 
 ...
 #initiatives h3.totalbusiness-item-title.totalbusiness-skin-title.totalbusiness-skin-border {color: {{config('app.color')}} !important;}

.totalbusiness-blog-grid .totalbusiness-blog-title { font-size: 14px; }

.totalbusiness-plain .about-us-read-more { float: right; }

h3.totalbusiness-item-title.totalbusiness-skin-title.totalbusiness-skin-border { color: {{config('app.color')}}; }
...
.totalbusiness-accordion-item.style-1 .accordion-title i.icon-minus {
    background-color: transparent;
    color: {{config('app.color')}} !important;
    padding-left: 0px;
    padding-right: 0px;}
...
.tablepress tbody td, .tablepress tfoot th { border-bottom: 2.5px solid {{config('app.color2')}} !important; }
...
h4.order-online { background-color: {{config('app.color')}};
    padding: 5px 10px;
    border-radius: 55px; }
...
h5.sl-contact2 a:hover {color: {{config('app.color')}}; }
...
.menu-icon-title a:hover { color: {{config('app.color')}}; }
...
a.bro-btn:hover { color: {{config('app.color')}};
    background-color: #fff; 
border: solid 1px {{config('app.color')}}; }
...
div.copyright-container.container div.copyright-right a:hover {color: {{config('app.color2')}} !important;}
