        ...
        <div class="row" style="margin-bottom:40px;">
          <div class="col-md-8 col-md-offset-2">
            ...
            <p>
             <label  id="hidde_info">  
             select a pickup location before payment </label>
            <h2> <input   disabled  style="font-weight: bolder"   type="submit"   value="Pay Now"    class="btn btn-success cartbutton"  id="submitr" /></h2>
