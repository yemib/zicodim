...
@section('content')
    ...
    <div class="above-sidebar-wrapper">
        ...
        <section id="content-section-1">
            <div class="totalbusiness-full-size-wrapper gdlr-show-all no-skin"
                            ...
                            <rs-slides>
                                ...
                                <div class="">
                                    <rs-slide data-key="rs-1" data-title="Slide"
                                        ...
                                        <img src="/slider/{{ $slidder->picture }}" alt="
						banner" title="Banner"
                                            width="1140" height="600" data-no-retina>
    ...
    <div class="with-sidebar-wrapper">
        ...
        <section id="content-section-2">
            ...
            <div class="totalbusiness-color-wrapper  gdlr-show-all no-skin" id="home-menu-icons"
                style="background-color: {{ config('app.color') }}; padding-top: 10px; padding-bottom: 10px; ">
                <div class="container">
                    <div class="totalbusiness-item totalbusiness-content-item" style="margin-bottom: 0px;">
                        <h3  style="background-color: {{ config('app.color2') }};" class="order-now-title"><a style="color:white">SHOP NOW</a>
                        </h3>
                        ...
                        <div id="wpcpro-wrapper" class="wpcp-carousel-wrapper wpcp-wrapper-946">
                            ...
                            <div id="sp-wp-carousel-pro-id-946"
                                class="wpcp-carousel-section sp-wpcp-946 wpcp-image-carousel wpcp-preloader wpcp-standard"
                               ...
                               {{--  <div  style="display: none !important" class="wpcp-single-item">

                                    @if( $all_category->picture != " ")
                                    <div class="wpcp-slide-image"><a href="/category/{{ $all_category->id }}"
                                            target="_top">
                                            <img src="/category2/{{ $all_category->picture }}"
                                                alt="{{ $all_category->name }}" width="170" height="170"></a></div>

                                                @endif


                                    <div class="wpcp-all-captions">
                                        <h2 class="wpcp-image-caption"><a href="/category/{{ $all_category->id }}"
                                                target="_top">{{ $all_category->name }}</a></h2>
                                    </div>
                                </div> --}}
        ...
        <section id="content-section-3">
            ...
            <div class="totalbusiness-color-wrapper  gdlr-show-all no-skin" id="love"
                ...
                <div class="container">
                    ...
                    <section class="card">
                        ...
                        @foreach ( $lastest_product as $product1)
                            @include('layouts.container_product')
                        @endforeach
            ...
            <section class="card">
                        ...
                        @foreach (  $old_product as $product1)
                            @include('layouts.container_product')
                        @endforeach
                ...
                <div class="totalbusiness-item totalbusiness-content-item">
                        ...
                        <h2 style="text-align: center;"><span class="spread-title-red">  </span> &nbsp;
                                ...
                                <a style="font-size: 20px" href="" class="btn btn-sm btn-primary">view all</a>
        ...
        <section id="content-section-4">
            ...
            <div class="totalbusiness-color-wrapper  gdlr-show-all no-skin"
                style="background-color: {{ config('app.color2') }}; padding-top: 30px; padding-bottom: 30px; ">
                <div class="container">
                    <div class="totalbusiness-item totalbusiness-content-item" style="margin-bottom: 0px;">
                        <h2 class="home-title" style="text-align: center;">{{ config('app.name') }}</h2>
                    </div>
                    <div class="clear"></div>
                    <div class="totalbusiness-item totalbusiness-content-item">
                        ...
                        <style>
                            ...
                            #wpcpro-wrapper #sp-wp-carousel-pro-id-798.wpcp-carousel-section.wpcp-image-carousel .wpcp-single-item .wpcp-all-captions {
                                background-color: {{ config('app.color') }} !important;
                            }
                        ...
                        <div id="wpcpro-wrapper" class="wpcp-carousel-wrapper wpcp-wrapper-957">
                            ...
                            <div id="sp-wp-carousel-pro-id-957"
                                class="wpcp-carousel-section sp-wpcp-957 wpcp-image-carousel nav-vertical-center wpcp-standard"
	...
	?>
                                ...
                                <div class="wpcp-single-item">
                                    ...
                                    <div class="wpcp-slide-image">
                                        ...
                                        <img src="/slider/{{ $sliddert->picture }}" title="" alt=""
                                            width="1551" height="812">
