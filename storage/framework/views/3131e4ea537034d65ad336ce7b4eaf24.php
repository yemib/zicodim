...
<head>
    ...
    <link href="<?php echo e(asset('css/general.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <meta property="og:image" content="https://zicodimmono.com.ng/slider/<?php echo e($logo->picture); ?>" />
    <meta property="og:url" content="https://zicodimmono.com.ng/<?php echo $__env->yieldContent('url'); ?>" />
    <meta property="og:type" content="e-commerce website" />
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="<?php echo $__env->yieldContent('title'); ?> --- <?php echo e(config('app.name')); ?>" />
    ...
    <meta name="twitter:image" content="https://zicodimmono.com.ng/slider/<?php echo e($logo->picture); ?>" />
    ...
    <link rel='stylesheet' id='style-responsive-css'
        ...
        <?php echo $__env->make('layouts.style-custom7a30', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <link rel="icon" href="/slider/<?php echo e($logo->picture); ?>" sizes="32x32" />
    <link rel="icon" href="/slider/<?php echo e($logo->picture); ?>" sizes="192x192" />
    <link rel="apple-touch-icon" href="/slider/<?php echo e($logo->picture); ?>" />
    ...
    <style>
        @font-face {
            ...
            src: url(<?php echo e(asset('fonts/' . $font->name)); ?> )
        }
...
<body class="home page-template-default page page-id-10 _masterslider _msp_version_3.2.14">
    ...
    <div class="body-wrapper  float-menu">
        ...
        <div class="content-wrapper">
            <div style="position: relative" class="totalbusiness-content">
                ...
                <?php echo $__env->make('layouts.side_cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


                <?php echo $__env->make('layouts/board', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('layouts.alertcon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <style>
            ...
            <a href="https://wa.me/<?php echo e($contact->whatapp); ?>" target="_blank" class="whatsapp-button"> 
                ...
                <div class="copyright-container container">
                    ...
                    <div class="copyright-right">
                        ...
                        <p> 
                              ...
                              <a  style="color:white"  href="tel:<?php echo e($contact->support); ?>">   <?php echo e($contact->support); ?> </a>
                              <br/>

                              <a style="color:white"  href="tel:+<?php echo e($contact->whatapp); ?>">+<?php echo e($contact->whatapp); ?></a>
                         </p>
                    ...
                    <div align="center">  Copyright <?php echo e(date('Y')); ?> <strong> <?php echo e(config('app.name')); ?></strong>, All Right Reserved.</div>
                </div>
            </div>
        </footer>
    </div> <!-- body-wrapper -->
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/jqueryzoom.js')); ?>"></script>


    <script type="text/javascript" src="<?php echo e(asset('js/lazy/jquery.lazy.min.js')); ?>"></script>
...
<?php /**PATH /home/itwtvmvh/public_html/zicodium/resources/views/layouts/index.blade.php ENDPATH**/ ?>