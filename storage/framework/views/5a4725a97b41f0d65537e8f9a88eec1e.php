...
$products  = add_product::find($checking_carts->product_id) ;
		...
		<div  class="col-sm-3"> 	<div   class="cartimage"   style="background-image: url('<?php echo e($image[0]['new_name']); ?>')"  >  </div> </div>
    ...
    <button  class="btn"   onClick="get_send('/decrease_cart/<?php echo e($checking_carts->id); ?>'   , 'inside_value<?php echo e($checking_carts->id); ?>' ,'individual_value<?php echo e($checking_carts->id); ?>','v_price<?php echo e($checking_carts->id); ?>' , 'maximum<?php echo e($checking_carts->id); ?>')"> <strong>-</strong></button> 
    
    <strong> <span  style="font-weight:bolder" class="btn"  id="inside_value<?php echo e($checking_carts->id); ?>">  <?php echo e($checking_carts->quantity); ?>    </span> </strong>
    
  
    <button  class="btn"   onClick="get_send('/increase_cart/<?php echo e($checking_carts->id); ?>'   , 'inside_value<?php echo e($checking_carts->id); ?>','individual_value<?php echo e($checking_carts->id); ?>','v_price<?php echo e($checking_carts->id); ?>', 'maximum<?php echo e($checking_carts->id); ?>' )" ><strong>+</strong></button>   <span  id="maximum<?php echo e($checking_carts->id); ?>">    </span>  
    
    
    
    
    <p>
    <strong   class="price_size"> &#x20A6;  <span   id="individual_value<?php echo e($checking_carts->id); ?>" > <?php echo e(number_format( $products->price *  $checking_carts->quantity )); ?></span></strong>
  </p>
...
<div class="col-sm-12" ><hr/></div>
 ...
 <h1> No Cart  </h1>
 <?php endif; ?>
 <?php /**PATH G:\websites\Zicodim\resources\views/cart/cart_list.blade.php ENDPATH**/ ?>