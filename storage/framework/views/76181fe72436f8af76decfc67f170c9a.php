    ...
    <div class="totalbusiness-content">
        ...
        <div class="with-sidebar-wrapper">
            <section id="content-section-2">
                <div class="totalbusiness-color-wrapper  gdlr-show-all no-skin" style="background-color: <?php echo e(config('app.color2')); ?>; padding-top: 20px; padding-bottom: 5px; ">
                    <div class="container">
                        <div class="totalbusiness-item totalbusiness-content-item" style="margin-bottom: 0px;">
                            <h2 class="home-title">
                                <span style="color: white;"> <?php echo e(config('app.name')); ?>  PORFOLIO</span>
                            </h2>
                        </div>
                        <div class="clear"></div>
                        <div class="clear"></div>
                        ...
                        <div class="blog-item-wrapper">
                            <div class="blog-item-holder">
                                <div class="totalbusiness-isotope" data-type="blog" data-layout="fitRows">
                                    ...
                                    <?php $__currentLoopData = $porfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <article id="post-2068" class="post-2068 post type-post status-publish format-standard has-post-thumbnail hentry category-news">
                                                    <div class="totalbusiness-standard-style">
                                                        <div class="totalbusiness-blog-thumbnail">
                                                            <a  target="_new" href="/slider/<?php echo e($portfolio->picture); ?>">
                                                                <img
                                                                    src="/slider/<?php echo e($portfolio->picture); ?>"
                                                            ...
                                                            <header class="post-header">
                                                                <div class="totalbusiness-blog-info">
                                                                    <div class="blog-info blog-date totalbusiness-skin-info">
                                                                        ...
                                                                        <a  target="_new" href="/slider/<?php echo e($portfolio->picture); ?>"> 04 Mar 2022</a>
                                                                    </div>
                                                                    <div class="clear"></div>
                                                                </div>
                                                                <h3 class="totalbusiness-blog-title">
                                                                    <a href="/slider/<?php echo e($portfolio->picture); ?>">View</a>
                                                                </h3>
                                                                <div class="clear"></div>
                                                            </header>
                                                            <!-- entry-header -->
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itwtvmvh/public_html/zicodium/resources/views/portfolio.blade.php ENDPATH**/ ?>