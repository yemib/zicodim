                ...
                <div class="">
                    ...
                    <div class="col-sm-12" style="width: 100%">
                        ...
                        <hr />  
                         ...
                         <div class="">
                            <div class="totalbusiness-content">
                                <?php if(isset($order->product->picture)): ?>
        
                                <?php if($order->product->picture != NULL): ?>

                                <?php $image =    json_decode($order->product->picture , true);   ?>


                                <a href="<?php echo e($image[0]['new_name']); ?>">
                                 



                                        <div style="background-image: url('<?php echo e($image[0]['new_name']); ?>')" class="image_container_product">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itwtech2/public_html/zicodim/resources/views/client/order_details.blade.php ENDPATH**/ ?>