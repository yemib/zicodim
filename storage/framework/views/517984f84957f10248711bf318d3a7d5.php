...
.top-navigation-wrapper{ background-color: <?php echo e(config('app.color2')); ?>; }
...
.totalbusiness-top-woocommerce, .totalbusiness-top-woocommerce-inner > a, .totalbusiness-menu-search input[type="text"]{ color: <?php echo e(config('app.color')); ?>; }
...
#totalbusiness-responsive-navigation.dl-menuwrapper button { background-color: <?php echo e(config('app.color2')); ?>; }
#totalbusiness-responsive-navigation.dl-menuwrapper button:hover, #totalbusiness-responsive-navigation.dl-menuwrapper button.dl-active, #totalbusiness-responsive-navigation.dl-menuwrapper ul{ background-color: <?php echo e(config('app.color2')); ?>; }
...
body{ color: #808080; }
a{ color: <?php echo e(config('app.color')); ?>; }
a:hover{ color: <?php echo e(config('app.color2')); ?>; }
body *{ border-color: #dddddd; }
.page-not-found-block{ background-color: <?php echo e(config('app.color')); ?>; }
.page-not-found-block{ color: #ffffff; }
.page-not-found-search  .gdl-search-form input[type="text"]{ background-color: <?php echo e(config('app.color2')); ?>; }
...
.totalbusiness-post-slider-item.style-no-excerpt .totalbusiness-caption-wrapper .totalbusiness-caption-date, .totalbusiness-post-slider-item.style-no-excerpt .totalbusiness-caption-wrapper .totalbusiness-title-link{ background-color: <?php echo e(config('app.color')); ?>; }
...
.footer-wrapper .totalbusiness-button, .footer-wrapper input[type="button"], .footer-wrapper input[type="submit"]{ background-color: <?php echo e(config('app.color')); ?>; }
.footer-wrapper .tagcloud a{ background-color: <?php echo e(config('app.color')); ?>; }
.footer-wrapper .tagcloud a, .footer-wrapper .tagcloud a:hover{ color: #ffffff; }
.copyright-wrapper{ background-color: <?php echo e(config('app.color')); ?>; }
.copyright-wrapper{ color: #ffffff; }
.footer-wrapper .copyright-wrapper{ border-color: <?php echo e(config('app.color')); ?>; }
...
@font-face {
    ...
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothammediumitalic-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothammediumitalic-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothammedium';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothammedium-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothammedium-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothamlight_italic';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothamlightitalic-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothamlightitalic-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothamlight';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothamlight-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothamlight-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothambook_italic';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothambookitalic-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothambookitalic-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothambook';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothambook-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothambook-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothambold_italic';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothambolditalic-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothambolditalic-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothambold';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothambold-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothambold-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal; }

@font-face {
    font-family: 'gothambookregular';
    src: url('/moi_content/themes/totalbusiness-child/fonts/gothambook_regular-webfont.html') format('woff2'),
         url('/moi_content/themes/totalbusiness-child/fonts/gothambook_regular-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
...
@font-face {
    ...
    src: url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNCn.html') format('woff2'),
        url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNCn.woff') format('woff');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNCnBold.html') format('woff2'),
        url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNCnBold.woff') format('woff');
    font-weight: bold;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNToasted.html') format('woff2'),
        url('/moi_content/themes/totalbusiness-child/fonts/GrilledCheeseBTNToasted.woff') format('woff');
    font-weight: normal;
    font-style: normal;
}
...
.txt-yellow { color: <?php echo e(config('app.color2')); ?>; }
...
.totalbusiness-main-menu > li.current-menu-item > a { border-bottom: solid 6px <?php echo e(config('app.color')); ?>; }
.totalbusiness-main-menu > li:hover > a { border-bottom: solid 6px <?php echo e(config('app.color')); ?>; }
...
@media only screen and (max-width: 767px)
{
     .totalbusiness-header-wrapper.header-style-6-wrapper .totalbusiness-header-inner { 
       background: <?php echo e(config('app.color')); ?> !important;  }
     .dl-menuwrapper > .dl-menu, .dl-menuwrapper > .dl-submenu { margin-top: 0px; }
}

.totalbusiness-header-wrapper.header-style-6-wrapper .top-navigation-wrapper { background: <?php echo e(config('app.color2')); ?>; }
...
.totalbusiness-main-menu > li:last-of-type a {  font-size: 24px !important;
    ...
    background: <?php echo e(config('app.color')); ?>;
    border-bottom: solid 24px <?php echo e(config('app.color2')); ?>;
    margin-top: -26px;
...
.totalbusiness-main-menu > li:last-of-type a::before { 
     background-image: url('/moi_content/uploads/2020/04/cart_two.jpg');
...
.totalbusiness-main-menu > li:last-of-type a::after { 
    ...
    position: absolute;
    top: 73px;
    color: <?php echo e(config('app.color')); ?>;
    letter-spacing: 1px;
}
...
.totalbusiness-main-menu > li:last-of-type a:hover { 
     background: blue; 
     color: <?php echo e(config('app.color')); ?>;  
     border-bottom: solid 24px <?php echo e(config('app.color')); ?>; }

.totalbusiness-main-menu > li:last-of-type a:hover .txt-yellow { color: <?php echo e(config('app.color')); ?>;  }

.totalbusiness-main-menu > li:last-of-type a:hover::after {  color: #ffffff;  }

.totalbusiness-main-menu > li:last-of-type a:hover::before { background-image: url('/moi_content/uploads/2020/04/cart_one.png'); }
...
.dl-menuwrapper li:last-of-type a:before {  background-image: url('/moi_content/uploads/2020/11/Ghana_MenuBtn.jpg');
    background-size: 240px 85px;
    display: inline-block;
    width: 240px; 
    height: 85px;
...
{ 
     ...
     .totalbusiness-main-menu > li:last-of-type a {  font-size: 17px !important;
       ...
       border-bottom: solid 18px <?php echo e(config('app.color2')); ?>; }
...
h3.order-now-title, h3.order-now-title-menu { text-align: center; 
    ...
    text-align: center;
    background-color: <?php echo e(config('app.color2')); ?>;
    color: <?php echo e(config('app.color')); ?>; 
    font-size: 27px;
...
h3.order-now-title:hover {
    ...
    color: <?php echo e(config('app.color')); ?>;   }
h3.order-now-title:hover a { color: <?php echo e(config('app.color')); ?>;   }

h3.order-now-title-menu:hover {  background-color: <?php echo e(config('app.color')); ?>;
    color: #ffffff; }
h3.order-now-title-menu:hover a { color: #ffffff; }

div#rest.totalbusiness-item.totalbusiness-content-item { background-color: <?php echo e(config('app.color')); ?>;
...
a.sl-btn {  color: #ffffff;
    background: <?php echo e(config('app.color')); ?>;
    border-bottom: solid 8px <?php echo e(config('app.color2')); ?>;
    padding: 10px;
    font-weight: bold;
    font-size: 18px;}
...
a.sl-btn:hover {  color: white;
    background: <?php echo e(config('app.color2')); ?>;
    border-bottom: solid 8px <?php echo e(config('app.color')); ?>;}
...
span.spread-title-red { color: <?php echo e(config('app.color')); ?>;
font-family: 'GrilledCheeseBold';
    font-size: 51px;
    font-weight: bold; } 
...
span.shout {color: <?php echo e(config('app.color')); ?>;
    font-weight: bold; }
...
a.sl-btn {  font-size: 12px; border-bottom: solid 4px <?php echo e(config('app.color2')); ?>; padding: 5px;  }
a.sl-btn:hover {  border-bottom: solid 4px <?php echo e(config('app.color')); ?>; }
...
#menu-item .portfolio-overlay-icon:hover  { color: <?php echo e(config('app.color')); ?>; }
...
#hover3 .portfolio-thumbnail .portfolio-overlay::after {
  ...
  width: 0;
  height: 100%;
  background-color: <?php echo e(config('app.color')); ?>;
  background: <?php echo e(config('app.color')); ?>;
...
.totalbusiness-blog-grid .totalbusiness-blog-grid-content { 
 ...
 #initiatives h3.totalbusiness-item-title.totalbusiness-skin-title.totalbusiness-skin-border {color: <?php echo e(config('app.color')); ?> !important;}

.totalbusiness-blog-grid .totalbusiness-blog-title { font-size: 14px; }

.totalbusiness-plain .about-us-read-more { float: right; }

h3.totalbusiness-item-title.totalbusiness-skin-title.totalbusiness-skin-border { color: <?php echo e(config('app.color')); ?>; }
...
.totalbusiness-accordion-item.style-1 .accordion-title i.icon-minus {
    background-color: transparent;
    color: <?php echo e(config('app.color')); ?> !important;
    padding-left: 0px;
    padding-right: 0px;}
...
.tablepress tbody td, .tablepress tfoot th { border-bottom: 2.5px solid <?php echo e(config('app.color2')); ?> !important; }
...
h4.order-online { background-color: <?php echo e(config('app.color')); ?>;
    padding: 5px 10px;
    border-radius: 55px; }
...
h5.sl-contact2 a:hover {color: <?php echo e(config('app.color')); ?>; }
...
/*-------404 PAGE-------*/
.totalbusiness-page-title-wrapper { background-image: url(/moi_content/uploads/2020/04/_BrandHeader.jpg); }
...
.menu-icon-title a:hover { color: <?php echo e(config('app.color')); ?>; }
...
a.bro-btn:hover { color: <?php echo e(config('app.color')); ?>;
    background-color: #fff; 
border: solid 1px <?php echo e(config('app.color')); ?>; }
...
div.copyright-container.container div.copyright-right a:hover {color: <?php echo e(config('app.color2')); ?> !important;}

 </style>   <?php /**PATH /home/itwtvmvh/public_html/zicodium/resources/views/layouts/style-custom7a30.blade.php ENDPATH**/ ?>