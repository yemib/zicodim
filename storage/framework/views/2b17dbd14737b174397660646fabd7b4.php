    ...
    <div class="totalbusiness-color-wrapper  gdlr-show-all no-skin" id="love" style="background-color: #ffffff; padding-top: 30px; padding-bottom: 30px; ">
        ...
        <div class="container">
            ...
            <section class="card">
                ...
                <?php $__currentLoopData = $lastest_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('layouts.container_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <section class="card">
                ...
                <?php $__currentLoopData = $old_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('layouts.container_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="six columns">
                <div class="totalbusiness-item totalbusiness-content-item" style="margin-bottom: 0px;">
                    ...
                    <p class="behind-text"  style="color: white">
                        ...
                        -Proving customers with technical advice and information as well as product samples of the latest market trend <br/>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\Zicodim\resources\views/home.blade.php ENDPATH**/ ?>