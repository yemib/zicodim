            ...
            <div style="overflow: auto; background: rgba(255,255,255,1.00)  ; padding: 10px">
                ...
                <div data-aos="zoom-out-up" id="ex3" style="" class="col-sm-12">
                  <h1>
                    ...
                    <span class="price_size"> &#x20A6; <strong> <?php echo e(number_format($product->price)); ?></strong> </span>

                    <?php if($product->coupon_price != 0): ?>
                        <p style="display: inline-block; " align="right"> <strong id="second_price"
                                style="text-decoration: line-through  ; color:#9b9b9b  ">&#x20A6;<?php echo e(number_format($product->coupon_price)); ?></strong>
                        </p>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\Zicodim\resources\views/product.blade.php ENDPATH**/ ?>