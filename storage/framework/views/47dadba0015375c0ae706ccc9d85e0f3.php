...
#wpcpro-wrapper #sp-wp-carousel-pro-id-798.sp-wpcp-798 .wpcp-all-captions .wpcp-image-caption a { color: <?php echo e(config('app.color2')); ?>;}
#wpcpro-wrapper #sp-wp-carousel-pro-id-798.sp-wpcp-798 .wpcp-all-captions .wpcp-image-description {color: #fff;}
#wpcpro-wrapper #sp-wp-carousel-pro-id-798.wpcp-carousel-section.wpcp-image-carousel .wpcp-single-item .wpcp-all-captions {background-color: <?php echo e(config('app.color')); ?> !important;}
...
#wpcpro-wrapper .slick-track .slick-slide .wpcp-single-item .wpcp-all-captions:after {
    ...
    border:3px solid <?php echo e(config('app.color')); ?>;
...
#menu-icons #wpcpro-wrapper .slick-track .slick-slide div a:hover .wpcp-single-item .wpcp-slide-image img { background: <?php echo e(config('app.color2')); ?>; } 
#menu-icons #wpcpro-wrapper .slick-track .slick-slide div a:hover .wpcp-single-item .wpcp-all-captions h2 a  { color:<?php echo e(config('app.color')); ?>; }
...
#home-menu-icons #wpcpro-wrapper .slick-track .slick-slide div a:hover .wpcp-single-item .wpcp-slide-image img { background: <?php echo e(config('app.color2')); ?>; } 
#home-menu-icons #wpcpro-wrapper .slick-track .slick-slide div a:hover .wpcp-single-item .wpcp-all-captions h2 a  { color:<?php echo e(config('app.color2')); ?>; }
...
@media only screen and (max-width: 554px)
{
    ...
    #home-menu-icons #wpcpro-wrapper .slick-track .slick-slide .wpcp-single-item .wpcp-all-captions * { font-family: 'gothambookregular' !important; } 
		...
		<?php /**PATH /home/itwtvmvh/public_html/zicodium/resources/views/layouts/style.blade.php ENDPATH**/ ?>