  ...
  <?php  $count = 1  ?>
   <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr>
     ...
     <td>
		 <a onClick="return confirmAlert('Delete Image ? ' , this.href)" href="/delete_slide/<?php echo e($categorys->id); ?>">  Delete  </a> 
...
<?php echo $__env->make('admin_dashboar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itwtech2/public_html/zicodim/resources/views/admin_folder/list_slider.blade.php ENDPATH**/ ?>