...
<?php echo $__env->make('admin_folder.upload_style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div align="center">
        <div align="left" style="padding: 20px  ; width: 80% ">
            ...
            <form  id="Form1" method="post" action="/add_product" enctype="multipart/form-data">
                ...
                <input type="number" required value="<?php if(isset($edit_list)): ?> <?php echo e($edit_list->quantity); ?> <?php endif; ?>"
                ...
                <input required type="" value="<?php if(isset($edit_list)): ?> <?php echo e($edit_list->price); ?> <?php endif; ?>"
                ...
                <input required type="" value="" name="coupon_price" class="form-control" />
...
<?php endif; ?>
                ...
                <textarea <?php if(session('admin')): ?> id="article-ckeditor" <?php endif; ?> name="warranty" class="form-control">
					<?php if(isset($edit_list)): ?>
<?php echo e($edit_list->description); ?>
...
<?php endif; ?>
                ...
                <textarea <?php if(session('admin')): ?> id="article-ckeditor" <?php endif; ?> name="policy" class="form-control">
					<?php if(isset($edit_list)): ?>
<?php echo e($edit_list->description); ?>
...
<?php endif; ?>
                ...
                <textarea <?php if(session('admin')): ?> id="article-ckeditor" <?php endif; ?> name="shipping" class="form-control">
				<?php if(isset($edit_list)): ?>
<?php echo e($edit_list->shipping); ?>
...
<?php endif; ?>
                ...
                <div class="col-sm-12">
                    ...
                    <?php if(session('admin')): ?>
                        <input id="public_status" type="checkbox" name="status" value="public" /> <label
                            for="public_status"> &nbsp; Make Public </label>
                    <?php endif; ?>
                    <br />
...
<?php echo $__env->make('admin_dashboar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\Zicodim\resources\views/admin_folder/add_product.blade.php ENDPATH**/ ?>