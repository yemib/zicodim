...
public 	$datanetwork;
	...
	function __construct($hostname="localhost" ,   $database_datanetwork="moi" , $username_datanetwork="root" ,   $password_datanetwork="" ) {
...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  switch ($theType) {
    ...
    case "text":
       $theValue = ($theValue != "") ?  htmlentities($theValue)  : "   ";
      break;
